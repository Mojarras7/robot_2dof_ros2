...
: ${AMENT_CURRENT_PREFIX:="/media/mojarras/Wiwi/sinFiltro/robot_2dof_ros2/install/kalman_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kalman_filter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kalman_filter/environment/path.sh"
